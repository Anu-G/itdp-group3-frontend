...
export const Profile = () => {
    const { businessProfileService } =  UseDep()
    ...
    const getUser = async () => {
        try {
            const response = await businessProfileService.doGetBusinessProfile({
            ...
            <div className='profile-page'>
                <div className='top-profile'>
                        ...
                        <div className='head-profile'>
                            ...
                            <div className='profile-text-item'>
                                ...
                                <div className='open-hour'>
                                    ...
                                    <Title2White title={`${openHour} - ${closeHour}`} />
                                </div>
                            </div>
                        </div>
                    ...
                    <div className='profile-buttons'>
                        ...
                        {profile.GmapsLink !== '' && <ButtonComponent label={'Visit Our Store'} onClick={handleClickGmaps}/> }                       
                    </div>
                </div>
